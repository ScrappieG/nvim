...
-- Sync clipboard between OS and Neovim using OSC52 (works over SSH).
...
require("lazy").setup({
	...
	-- "NMAC427/guess-indent.nvim", -- disabled: always use 4 spaces (see expandtab/shiftwidth above)
			...
			require("github-theme").setup({
				...
				groups = {
					github_dark = {
						Normal       = { bg = "#070809" },
						NormalNC     = { bg = "#070809" },
						NormalFloat  = { bg = "#0a0c0e" },
						SignColumn   = { bg = "#070809" },
						LineNr       = { bg = "#070809" },
						EndOfBuffer  = { bg = "#070809" },
						StatusLine   = { bg = "#070809" },
						StatusLineNC = { bg = "#070809" },
					},
				},
			})
